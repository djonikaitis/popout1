...
% Fixation stimulus
coord1 = expsetup.stim.esetup_fixation_coord(tid,1:2);
...
sz1 = expsetup.stim.esetup_st1_size(tid,1:4);
...
sz1 = expsetup.stim.esetup_st2_size(tid,1:4);
...
coord1 = expsetup.stim.popout_coord; % One column, one object
sz1 = expsetup.stim.esetup_popout_size(tid,1:4);
popout_rect = runexp_convert_deg2pix_rect_v10(coord1, sz1); % Output - one column - one object;
